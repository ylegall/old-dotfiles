...
" Call the 'highlight' function with a list of args.
...
let s:colors.base1 = { 'gui': '#11151c', 'cterm': 234 }
...
let s:colors.base8 = { 'gui': '#99d1ce', 'cterm': 73  }
let s:colors.base9 = { 'gui': '#599cab', 'cterm': 179 }

" Other colors.
let s:colors.red     = { 'gui': '#c23127', 'cterm': 1   }
let s:colors.coral   = { 'gui': '#c23127', 'cterm': 138 }
let s:colors.orange  = { 'gui': '#d26937', 'cterm': 166 }
let s:colors.orange2 = { 'gui': '#d26937', 'cterm': 203 }
let s:colors.yellow  = { 'gui': '#edb443', 'cterm': 214 }
let s:colors.magenta = { 'gui': '#888ca6', 'cterm': 74  }
...
" default text
call s:Col('Normal', 'base8', s:background)
...
call s:Col('LineNr', 'base4', s:background)
...
call s:Col('Statement', 'base9')
call s:Attr('Statement', 'bold')
call s:Col('Special', 'orange2')
call s:Attr('Special', 'bold')
call s:Col('Identifier', 'base5')
call s:Col('Identifier', 'base5')

" Constants, symbols.
call s:Col('Constant', 'magenta')
call s:Attr('Constant', 'bold')
...
" Types, HTML attributes, (and class names).
call s:Col('Type', 'coral')
call s:Attr('Type', 'bold')

" Stuff like 'import'
call s:Col('PreProc', 'coral')
